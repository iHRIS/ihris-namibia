Profile:        IhrisScannedDocument
Parent:         IhrisPractitionerBasic
Id:             ihris-scanned-document
...
* item[0].linkId = "Basic"
* item[0].definition = "http://ihris.org/fhir/StructureDefinition/ihris-scanned-document"
* item[0].text = "Scanned Document"
* item[0].type = #group

* item[0].item[0].linkId = "Basic.id"
* item[0].item[0].definition = "http://ihris.org/fhir/StructureDefinition/ihris-scanned-document#Basic.id"
* item[0].item[0].text = "Details"
* item[0].item[0].type = #group

* item[0].item[0].item[0].linkId = "Basic.extension[0]"
* item[0].item[0].item[0].definition = "http://ihris.org/fhir/StructureDefinition/ihris-scanned-document#Basic.extension:name.value[x]:valueString"
* item[0].item[0].item[0].text = "Attachment Name"
* item[0].item[0].item[0].type = #string
* item[0].item[0].item[0].required = true
* item[0].item[0].item[0].repeats = false

* item[0].item[0].item[1].linkId = "Basic.extension[1]"
* item[0].item[0].item[1].definition = "http://ihris.org/fhir/StructureDefinition/ihris-scanned-document#Basic.extension:upload-date.value[x]:valueDate"
* item[0].item[0].item[1].text = "Date Uploaded"
* item[0].item[0].item[1].type = #date
* item[0].item[0].item[1].required = true
* item[0].item[0].item[1].repeats = false

* item[0].item[0].item[2].linkId = "Basic.extension[2]"
* item[0].item[0].item[2].definition = "http://ihris.org/fhir/StructureDefinition/ihris-scanned-document#Basic.extension:scanned-document.value[x]:valueAttachment"
* item[0].item[0].item[2].text = "Document"
* item[0].item[0].item[2].type = #attachment
...
* extension[display].extension[resource].valueReference = Reference(StructureDefinition/ihris-scanned-document)
