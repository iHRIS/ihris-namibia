...
* extension[display].extension[search][2].valueString = "Other name|Practitioner.name.extension:otherName"
...
* extension[section][3].extension[resource].extension[column][4].extension[field].valueString = "PractitionerRole.extension:employmentTerms"
* extension[section][3].extension[resource].extension[column][5].extension[header].valueString = "Supervisor"
* extension[section][3].extension[resource].extension[column][5].extension[field].valueString = "PractitionerRole.extension:supervisor"
