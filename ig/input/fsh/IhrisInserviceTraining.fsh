...
* extension[inservicetraining].extension[training].valueCoding ^label = "Training Type"
...
* extension[training].valueCoding ^label = "Training Type"
...
* item[0].item[0].item[1].definition = "http://ihris.org/fhir/StructureDefinition/ihris-basic-inservice-training#Basic.extension:inservicetraining.extension:training.value[x]:valueCoding"
* item[0].item[0].item[1].text = "Training Type"
