...
* extension.extension[=].extension[=].extension[=].valueString = "%s %s %s"
* extension.extension[=].extension[=].extension[+].url = "order"
* extension.extension[=].extension[=].extension[=].valueString = "given, family, other"
* extension.extension[=].extension[=].extension[+].url = "paths:given:fhirpath"
* extension.extension[=].extension[=].extension[=].valueString = "name.given"
...
* extension.extension[=].extension[=].extension[=].valueString = "name.family"
* extension.extension[=].extension[=].extension[+].url = "paths:other:fhirpath"
* extension.extension[=].extension[=].extension[=].valueString = "name.extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-practitioner-othername').valueString"
